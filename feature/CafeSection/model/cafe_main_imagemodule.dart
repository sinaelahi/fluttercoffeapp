...
class CafeMainImagemodule {
 List<CafeModel> getdata(){
  ...
  CafeModel cafemodel4 = CafeModel(
    ...
    desc: "Ice/Hot",
    price: "6.53");
  CafeModel cafemodel5 = CafeModel(
    coffeeurl: 'assets/images/5.png',
    coffename: "Milk",
    desc: "Ice/Hot",
    price: "6.53");
  CafeModel cafemodel6 = CafeModel(
    coffeeurl: 'assets/images/2.png',
    coffename: "Choclate",
    desc: "Deep Foam",
    price: "6.53");
  CafeModel cafemodel7 = CafeModel(
    coffeeurl: 'assets/images/3.png',
    coffename: "Mocha",
    desc: "Deep Foam",
    price: "6.53");
  ...
  coffeeimages.add(cafemodel5);
  coffeeimages.add(cafemodel6);
  coffeeimages.add(cafemodel7);
